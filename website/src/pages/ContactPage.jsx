...
export default function ContactPage({ onShowToast }) {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setSubmitting(false);
      setSubmitted(true);
      onShowToast('Thank you! Your message has been received by our support team.', 'success');
      setFormData({
        fullName: '',
        phone: '',
        email: '',
              ...
              <div className="contact-cards-stack">
                ...
                <div className="contact-touch-card">
                  ...
                  <div>
                    ...
                    <a href="mailto:supportbete@gmail.com" className="touch-value">supportbete@gmail.com</a>
                  </div>
                </div>
                ...
                <div className="contact-touch-card contact-social-card">
                  ...
                  <div>
                    ...
                    <div className="contact-social-links">
                      <a
                        href="https://facebook.com/bete"
                        target="_blank"
                        rel="noreferrer"
                        className="social-chip facebook"
                        aria-label="Facebook"
                        title="Bete on Facebook"
                      >
                      ...
                      <a
                        href="https://linkedin.com/company/bete"
                        target="_blank"
                        rel="noreferrer"
                        className="social-chip linkedin"
                        aria-label="LinkedIn"
                        title="Bete on LinkedIn"
                      >
                        <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true">
              ...
              <div className="contact-form-card">
                ...
                <form onSubmit={handleSubmit} className="actual-contact-form" noValidate>
                  ...
                  <p className="form-privacy-note">
                    By submitting, you agree to Bete's privacy policy. For urgent repair requests, please download and book via the <strong>Bete mobile app</strong>.
                  </p>
                </form>
              </div>
            </div>
