...
export default function LoginScreen() {
  ...
  const handleSignIn = async () => {
    ...
    setLoading(true);
    try {
      // Send as 'identifier' so backend checks BOTH email and phone
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push("/screen/forgot-password" as any)}
            >
...
const styles = StyleSheet.create({
  ...
  checkboxActive: { backgroundColor: "#0052CC", borderColor: "#0052CC" },
  agreementText: { flex: 1, fontSize: 12, color: "#475569", lineHeight: 18 },
  linkText: { color: "#0052CC", fontWeight: "600" },
  signInBtn: {
    height: 48,
